      ...
      child: Padding(
        ...
        child: ElevatedButton(
          ...
          child: FittedBox(
            ...
            child: icon != null
                ? Icon(icon, size: 27 * scale, color: Colors.white)
                : Text(
                    text,
                    style: TextStyle(
                      fontSize: 22 * scale,
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          // Row 1: Actions Bar (Clear All, Clear, Backspace, Submit)
          row(context, [
            button(
              context,
              "AC",
